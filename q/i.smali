...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lq/i;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_8
    :try_start_8
    invoke-static {p0, p1, p2}, Lq/i;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_12
    :try_start_12
    invoke-static {p0}, Lq/i;->g(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :try_start_4
    invoke-static {p0, p1}, Lq/i;->d(Ljava/io/File;Ljava/io/InputStream;)Z

    move-result p0
    :try_end_8
    .catchall {:try_start_4 .. :try_end_8} :catchall_c

    invoke-static {p1}, Lq/i;->a(Ljava/io/Closeable;)V
...
.method public static d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    invoke-static {v3}, Lq/i;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v2}, Lq/i;->a(Ljava/io/Closeable;)V
