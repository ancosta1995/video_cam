...
.method static constructor <clinit>()V
    ...
    :goto_57
    sput-object v0, Lq/d;->c:Ljava/lang/reflect/Constructor;

    sput-object v1, Lq/d;->b:Ljava/lang/Class;

    sput-object v4, Lq/d;->d:Ljava/lang/reflect/Method;

    sput-object v2, Lq/d;->e:Ljava/lang/reflect/Method;
...
.method private static g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :try_start_1
    sget-object v1, Lq/d;->d:Ljava/lang/reflect/Method;
...
.method private static h(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    :try_start_1
    sget-object v1, Lq/d;->b:Ljava/lang/Class;
...
.method public a(Landroid/content/Context;Lp/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {}, Lq/d;->j()Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lp/a$c;->b()I

    move-result v4

    invoke-static {p1, p3, v4}, Lq/i;->b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    :cond_1d
    invoke-virtual {v3}, Lp/a$c;->c()I

    move-result v5

    invoke-virtual {v3}, Lp/a$c;->e()I

    move-result v6

    invoke-virtual {v3}, Lp/a$c;->f()Z

    move-result v3

    invoke-static {p4, v4, v5, v6, v3}, Lq/d;->g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lv/b$f;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v5}, Lv/b$f;->c()Landroid/net/Uri;
    ...
    invoke-static {p1, p2, v6}, Lq/i;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
    ...
    :cond_29
    invoke-virtual {v5}, Lv/b$f;->b()I

    move-result v6

    invoke-virtual {v5}, Lv/b$f;->d()I

    move-result v8

    invoke-virtual {v5}, Lv/b$f;->e()Z

    move-result v5

    invoke-static {v0, v7, v6, v8, v5}, Lq/d;->g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :cond_3f
    invoke-static {v0}, Lq/d;->h(Ljava/lang/Object;)Landroid/graphics/Typeface;
