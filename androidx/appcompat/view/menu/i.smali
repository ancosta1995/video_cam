...
.method private a()Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->t(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->o(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->i:Landroidx/appcompat/view/menu/j$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/j;->g(Landroidx/appcompat/view/menu/j$a;)V

    iget-boolean v1, p0, Landroidx/appcompat/view/menu/i;->h:Z

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->q(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/i;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->r(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->u(Z)V
    ...
    invoke-static {p4}, Ly/p;->t(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Ly/c;->b(II)I
    ...
    :cond_21
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->s(I)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/h;->v(I)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->p(Landroid/graphics/Rect;)V

    :cond_48
    invoke-interface {v0}, Lg/e;->show()V
...
.method public b()V
    ...
    invoke-interface {v0}, Lg/e;->dismiss()V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->q(Z)V
