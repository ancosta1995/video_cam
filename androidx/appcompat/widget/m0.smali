...
.field private static final j:Landroidx/appcompat/widget/m0$a;
...
.field private g:Landroidx/appcompat/widget/m0$c;
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Lk/d;->j(JLjava/lang/Object;)V
    :try_end_23
...
.method private e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v1, v2}, Landroidx/appcompat/widget/m0;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
...
.method private declared-synchronized h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_e
    :try_start_e
    invoke-virtual {v0, p2, p3}, Lk/d;->e(J)Ljava/lang/Object;
    ...
    :cond_28
    :try_start_28
    invoke-virtual {v0, p2, p3}, Lk/d;->c(J)V
    :try_end_2b
...
.method private static o(Landroidx/appcompat/widget/m0;)V
    .registers 1
...
.method private q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/m0;->b:Lk/a;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/m0;->c:Lk/h;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/m0;->b:Lk/a;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/m0;->c:Lk/h;
    ...
    invoke-direct {p0, p1, v4, v5}, Landroidx/appcompat/widget/m0;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/m0;->c:Lk/h;

    invoke-virtual {v8, p2, v3}, Lk/h;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/m0;->b:Lk/a;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/m0;->c:Lk/h;
...
.method private u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_10
    invoke-static {p4}, Lr/a;->m(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    invoke-static {p4, v0}, Lr/a;->j(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p4, p1}, Lr/a;->k(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/m0$c;->d(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method static v(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/u0;[I)V
    .registers 5
...
.method declared-synchronized j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_1
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/m0;->c(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/m0;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2}, Lo/a;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/m0;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/m0;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_d
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/m0$c;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/appcompat/widget/m0;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_16
...
.method n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_6
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/m0$c;->e(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/b1;I)Landroid/graphics/drawable/Drawable;
    .registers 5

    monitor-enter p0

    :try_start_1
    invoke-direct {p0, p1, p3}, Landroidx/appcompat/widget/m0;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/m0;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/m0$c;->b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
