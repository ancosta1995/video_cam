...
.field private static final z:Lx/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lx/e<",
...
.field private t:Ly/n;

.field private final u:Ly/m;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lx/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Ly/m;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:Ly/m;

    const/4 v0, 0x0

    sget-object v1, Ll/c;->b:[I
    ...
    invoke-static {p0}, Ly/p;->r(Landroid/view/View;)I
...
.method private D(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;

    if-eqz v1, :cond_6f

    invoke-static {p0}, Ly/p;->q(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;

    invoke-virtual {v2}, Ly/x;->b()I
    ...
    invoke-static/range {v1 .. v6}, Ly/c;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-static {v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    return-void
.end method

.method private E(Landroid/view/View;Landroid/view/View;I)V
    .registers 8
    ...
    invoke-static {v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
...
.method private F(Landroid/view/View;II)V
    ...
    invoke-static {v1, p3}, Ly/c;->b(II)I
    ...
    :cond_29
    invoke-direct {p0, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x(I)I
...
.method private G(Landroid/view/View;Landroid/graphics/Rect;I)V
    .registers 12

    invoke-static {p1}, Ly/p;->H(Landroid/view/View;)Z
    ...
    :goto_73
    invoke-static {v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
    ...
    invoke-static {v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, p1, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->W(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->W(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, p3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->V(Landroid/view/View;I)V
...
.method static L(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    .registers 8
...
.method private static P(Landroid/graphics/Rect;)V
    .registers 2

    invoke-virtual {p0}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lx/e;
...
.method private V(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ly/p;->M(Landroid/view/View;I)V
...
.method private W(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ly/p;->N(Landroid/view/View;I)V
...
.method private Y()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Ly/n;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Ly/n;

    :cond_11
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Ly/n;

    invoke-static {p0, v0}, Ly/p;->l0(Landroid/view/View;Ly/n;)V
...
.method private e(Ly/x;)Ly/x;
    .registers 6

    invoke-virtual {p1}, Ly/x;->e()Z
    ...
    invoke-static {v2}, Ly/p;->q(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->f(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Ly/x;)Ly/x;
...
.method private w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    .registers 13
    ...
    invoke-static {p1, p2}, Ly/c;->b(II)I

    move-result p1

    iget p5, p5, Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;->d:I

    invoke-static {p5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->T(I)I

    move-result p5

    invoke-static {p5, p2}, Ly/c;->b(II)I
...
.method H(Landroid/view/View;I)V
    ...
    invoke-virtual {v8, v0, v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u(Landroid/view/View;Landroid/graphics/Rect;)V

    const/4 v14, 0x0

    invoke-virtual {v8, v9, v14, v12}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->r(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    ...
    invoke-static {v9, v0}, Ly/p;->M(Landroid/view/View;I)V

    :cond_5c
    if-eqz v1, :cond_61

    invoke-static {v9, v1}, Ly/p;->N(Landroid/view/View;I)V
    ...
    :cond_6e
    invoke-static {v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v12}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v13}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
...
.method final I(I)V
    ...
    invoke-virtual {v0, v9, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->H(Landroid/view/View;I)V
    ...
    invoke-static {v12, v2}, Ly/c;->b(II)I
    ...
    invoke-direct {v0, v9, v4, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->G(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    :cond_c3
    invoke-virtual {v0, v9, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->O(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    :cond_107
    invoke-static {v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V

    invoke-static {v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
...
.method public J(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, v1, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->E(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, v0, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->F(Landroid/view/View;II)V
...
.method final X(Ly/x;)Ly/x;
    .registers 5

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;
    ...
    invoke-direct {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e(Ly/x;)Ly/x;
...
.method public g(Landroid/view/View;Landroid/view/View;)Z
    .registers 7
    ...
    :goto_1b
    invoke-virtual {p0, p1, v2, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->r(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    :goto_2b
    invoke-virtual {p0, p2, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->r(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    invoke-static {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->P(Landroid/graphics/Rect;)V
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->l()Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
...
.method public final getLastWindowInsets()Ly/x;
    .registers 2
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:Ly/m;
...
.method public h(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Ly/m;->c(Landroid/view/View;Landroid/view/View;II)V
...
.method public i(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Ly/m;->d(Landroid/view/View;I)V
...
.method protected l()Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    .registers 3
...
.method public onAttachedToWindow()V
    ...
    invoke-direct {p0, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method protected onMeasure(II)V
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;

    if-eqz v3, :cond_4b

    invoke-static/range {p0 .. p0}, Ly/p;->q(Landroid/view/View;)Z
    ...
    invoke-direct {v7, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x(I)I

    move-result v0

    iget v11, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;->c:I

    invoke-static {v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->U(I)I

    move-result v11

    invoke-static {v11, v10}, Ly/c;->b(II)I
    ...
    invoke-static/range {v20 .. v20}, Ly/p;->q(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_f1

    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;

    invoke-virtual {v0}, Ly/x;->b()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;
    ...
    iget-object v11, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Ly/x;

    invoke-virtual {v11}, Ly/x;->a()I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_54
    invoke-direct {v0, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method protected q(Landroid/view/ViewGroup$LayoutParams;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    .registers 3
...
.method r(Landroid/view/View;ZLandroid/graphics/Rect;)V
    .registers 6
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public setStatusBarBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, Lo/a;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method v(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    .registers 16
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
...
.method z(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    .registers 8
