...
.method constructor <init>(Lcom/google/android/material/chip/Chip;Lcom/google/android/material/chip/Chip;)V
    ...
    invoke-direct {p0, p2}, Lc0/a;-><init>(Landroid/view/View;)V
...
.method protected M(Lz/c;)V
    ...
    invoke-virtual {p1, v0}, Lz/c;->U(Z)V
    ...
    invoke-virtual {p1, v0}, Lz/c;->X(Z)V
    ...
    :goto_25
    invoke-virtual {p1, v0}, Lz/c;->W(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lz/c;->q0(Ljava/lang/CharSequence;)V

    return-void
.end method

.method protected N(ILz/c;)V
    .registers 9
    ...
    :goto_d
    invoke-virtual {p2, p1}, Lz/c;->a0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Lz/c;->S(Landroid/graphics/Rect;)V

    sget-object p1, Lz/c$a;->i:Lz/c$a;

    invoke-virtual {p2, p1}, Lz/c;->b(Lz/c$a;)V
    ...
    invoke-virtual {p2, p1}, Lz/c;->b0(Z)V

    goto :goto_56

    :cond_4c
    invoke-virtual {p2, v0}, Lz/c;->a0(Ljava/lang/CharSequence;)V
