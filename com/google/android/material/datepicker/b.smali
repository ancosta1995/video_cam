...
# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILb1/k;Landroid/graphics/Rect;)V
    .registers 8
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lb1/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, Lx/h;->a(ZLjava/lang/Object;)V

    sget-object v1, Lm0/k;->O1:[I
    ...
    invoke-static {p0, p1, v1}, Ly0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lb1/k;->b(Landroid/content/Context;II)Lb1/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lb1/k$b;->m()Lb1/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILb1/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lb1/k;

    invoke-virtual {v0, v2}, Lb1/g;->setShapeAppearanceModel(Lb1/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lb1/k;

    invoke-virtual {v1, v2}, Lb1/g;->setShapeAppearanceModel(Lb1/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lb1/g;->V(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Ly/p;->d0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
