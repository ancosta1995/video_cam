...
.method private L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ln0/i;Ln0/i;FFFFLandroid/graphics/RectF;)V
    .registers 10

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ln0/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ln0/i;FF)F
...
.method private N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_14
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Ln0/h;->e(Ljava/lang/String;)Ln0/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;
    ...
    :goto_3a
    invoke-virtual {p2, p3}, Ln0/h;->e(Ljava/lang/String;)Ln0/i;
...
.method private O(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    .registers 6
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ln0/j;)F
...
.method private P(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    .registers 6
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ln0/j;)F
...
.method private Q(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    .registers 6
...
.method private R(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    .registers 6
...
.method private S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ln0/i;FF)F
    .registers 13

    invoke-virtual {p2}, Ln0/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Ln0/i;->d()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Ln0/h;->e(Ljava/lang/String;)Ln0/i;
    ...
    invoke-virtual {p2}, Ln0/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Ln0/a;->a(FFF)F
...
.method private U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object p3, Ln0/d;->a:Landroid/util/Property;
    ...
    :cond_25
    sget-object p2, Ln0/d;->a:Landroid/util/Property;
    ...
    :goto_3c
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;
    ...
    invoke-virtual {p2, p1}, Ln0/i;->a(Landroid/animation/Animator;)V
...
.method private V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {p2, p1}, Lq0/d;->setCircularRevealScrimColor(I)V

    :cond_18
    sget-object p1, Lq0/d$d;->a:Landroid/util/Property;
    ...
    :cond_23
    sget-object p3, Lq0/d$d;->a:Landroid/util/Property;
...
.method private W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ln0/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    ...
    invoke-virtual {v1, v0}, Ln0/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Ln0/i;->a(Landroid/animation/Animator;)V
...
.method private X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p1}, Ly/p;->p(Landroid/view/View;)F
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Ln0/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Ln0/h;->e(Ljava/lang/String;)Ln0/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Lq0/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Lq0/d;->setRevealInfo(Lq0/d$e;)V

    :cond_42
    if-eqz p4, :cond_4b

    invoke-interface {v13}, Lq0/d;->getRevealInfo()Lq0/d$e;

    move-result-object v0

    iget v0, v0, Lq0/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Lw0/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Lq0/a;->a(Lq0/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lq0/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Ln0/i;->c()J
    ...
    iget v6, v0, Lq0/d$e;->c:F

    invoke-static {v13, v1, v10, v11}, Lq0/a;->a(Lq0/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Ln0/i;->d()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ln0/h;

    invoke-virtual {v0}, Ln0/h;->f()J
    ...
    :goto_ab
    invoke-virtual {v14, v9}, Ln0/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Lq0/a;->b(Lq0/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_23
    sget-object p3, Ln0/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Ln0/h;->e(Ljava/lang/String;)Ln0/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Ln0/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lq0/d;Landroid/graphics/drawable/Drawable;)V
...
.method private c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ln0/j;)F

    move-result v4

    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ln0/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ln0/j;)F
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ln0/i;Ln0/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_70
    invoke-virtual {v12, v14}, Ln0/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Ln0/i;->a(Landroid/animation/Animator;)V
...
.method private d0(Landroid/view/View;)I
    ...
    invoke-static {p1}, Ly/p;->l(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method protected J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Ln0/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
