...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln/b;->g:Landroid/os/Handler;

    invoke-static {}, Ln/b;->a()Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Ln/b;->a:Ljava/lang/Class;

    invoke-static {}, Ln/b;->b()Ljava/lang/reflect/Field;

    move-result-object v1

    sput-object v1, Ln/b;->b:Ljava/lang/reflect/Field;

    invoke-static {}, Ln/b;->f()Ljava/lang/reflect/Field;

    move-result-object v1

    sput-object v1, Ln/b;->c:Ljava/lang/reflect/Field;

    invoke-static {v0}, Ln/b;->d(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v1

    sput-object v1, Ln/b;->d:Ljava/lang/reflect/Method;

    invoke-static {v0}, Ln/b;->c(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v1

    sput-object v1, Ln/b;->e:Ljava/lang/reflect/Method;

    invoke-static {v0}, Ln/b;->e(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v0

    sput-object v0, Ln/b;->f:Ljava/lang/reflect/Method;
...
.method protected static h(Ljava/lang/Object;Landroid/app/Activity;)Z
    ...
    :try_start_1
    sget-object v1, Ln/b;->c:Ljava/lang/reflect/Field;
    ...
    :cond_a
    sget-object p0, Ln/b;->b:Ljava/lang/reflect/Field;

    invoke-virtual {p0, p1}, Ljava/lang/reflect/Field;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    sget-object p1, Ln/b;->g:Landroid/os/Handler;

    new-instance v2, Ln/b$c;

    invoke-direct {v2, p0, v1}, Ln/b$c;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method static i(Landroid/app/Activity;)Z
    ...
    sget-object v0, Ln/b;->f:Ljava/lang/reflect/Method;
    ...
    :cond_17
    sget-object v0, Ln/b;->e:Ljava/lang/reflect/Method;

    if-nez v0, :cond_20

    sget-object v0, Ln/b;->d:Ljava/lang/reflect/Method;
    ...
    :cond_20
    :try_start_20
    sget-object v0, Ln/b;->c:Ljava/lang/reflect/Field;
    ...
    :cond_29
    sget-object v3, Ln/b;->b:Ljava/lang/reflect/Field;
    ...
    invoke-direct {v5, p0}, Ln/b$d;-><init>(Landroid/app/Activity;)V

    invoke-virtual {v4, v5}, Landroid/app/Application;->registerActivityLifecycleCallbacks(Landroid/app/Application$ActivityLifecycleCallbacks;)V

    sget-object v6, Ln/b;->g:Landroid/os/Handler;

    new-instance v7, Ln/b$a;

    invoke-direct {v7, v5, v0}, Ln/b$a;-><init>(Ln/b$d;Ljava/lang/Object;)V
    ...
    sget-object p0, Ln/b;->f:Ljava/lang/reflect/Method;
    ...
    :goto_7c
    :try_start_7c
    new-instance p0, Ln/b$b;

    invoke-direct {p0, v4, v5}, Ln/b$b;-><init>(Landroid/app/Application;Ln/b$d;)V
    ...
    sget-object v0, Ln/b;->g:Landroid/os/Handler;

    new-instance v1, Ln/b$b;

    invoke-direct {v1, v4, v5}, Ln/b$b;-><init>(Landroid/app/Application;Ln/b$d;)V
