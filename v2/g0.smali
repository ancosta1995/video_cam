...
.method public static varargs d([Lu2/g;)Ljava/util/Map;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {v1}, Lv2/f0;->a(I)I

    move-result v1

    invoke-direct {v0, v1}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {v0, p0}, Lv2/g0;->e(Ljava/util/Map;[Lu2/g;)V

    return-object v0
.end method

.method public static final e(Ljava/util/Map;[Lu2/g;)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-virtual {v2}, Lu2/g;->a()Ljava/lang/Object;

    move-result-object v3

    invoke-virtual {v2}, Lu2/g;->b()Ljava/lang/Object;
...
.method public static f(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lv2/d0;->g(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_13
    invoke-static {p0}, Lv2/f0;->b(Ljava/util/Map;)Ljava/util/Map;
